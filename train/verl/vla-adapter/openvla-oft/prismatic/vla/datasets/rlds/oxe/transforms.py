...
def realworld_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # gripper action is in -1 (open)...1 (close) --> clip to 0...1, flip --> +1 = open, 0 = close
    gripper_action = trajectory["action"][:, -1:]
    gripper_action = invert_gripper_actions(tf.clip_by_value(gripper_action, 0, 1))
    ...
    trajectory["observation"]["EEF_state"] = trajectory["observation"]["state"][:, :5]
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    ### Real World (modified versions)
    "realworld": realworld_dataset_transform,
    "blue_block": realworld_dataset_transform,
    "orange_block": realworld_dataset_transform,
    "red_block": realworld_dataset_transform,
    "yellow_block": realworld_dataset_transform,
