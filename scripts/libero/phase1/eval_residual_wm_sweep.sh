...
log "action_ablation   : ${ACTION_ABLATION}"
log "debug_visuals     : ${SAVE_DEBUG_VISUALS}"
log "use_manifest      : ${USE_WINDOW_MANIFEST:-0}"
log "window_manifest   : ${WINDOW_MANIFEST:-<none>}"
log "venv              : ${VENV_NAME}"
log "device            : ${DEVICE}"
...
ACTION_ABLATION=${ACTION_ABLATION} SAVE_DEBUG_VISUALS=${SAVE_DEBUG_VISUALS} \\
USE_WINDOW_MANIFEST=${USE_WINDOW_MANIFEST:-0} WINDOW_MANIFEST=${WINDOW_MANIFEST:-} \\
